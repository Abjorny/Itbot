...
var checkboxes = document.getElementsByClassName('input-checkbox5');

Array.from(checkboxes).forEach(function(checkbox) {
  checkbox.addEventListener('click', function() {
    var inputN = document.querySelector("#next4-btn");
    var spanElement = this.querySelector('span');
...
function push() {
  ...
  if (value !== '') {
      ...
      document.querySelector(".select-middle").style=`bottom:-200px`
      document.querySelector('.viber-close1').innerHTML = newData
          .map((item , key) => `
              <div class="bnt-x">
              <span>${item}</span>
...
function next() {
  ...
  if (nextButtonBgColor === 'rgb(47, 128, 237)') {
    ...
    document.querySelector("#select-none").style=`display:none`
...
function test() {
  ...
  function nazad(){
    ...
    document.getElementById("ikincisi").style=`display:none`
       document.querySelector("#select-none").style=`display:block`
    // rang
  ...
  function openBlock1(){
    ...
    var a = false;
    if(y==="none"){
      document.querySelector("#select-none").style=`
      position: relative;
      top: -150px;
      
      `
        document.querySelector("#pas").style.display="block";
        document.querySelector(".tepa-block").style=`
        border-radius: 0px;
        border: 1px solid white;
        `
        document.querySelector(".filter-block-2").style=`
        border-radius: 8px;
...
function changeText(text) {
    var ozgaruvchiElement = document.getElementById("ozgaruvchi");
    ozgaruvchiElement.innerHTML = text;
    document.querySelector("#pas").style=`display:none`
    document.querySelector("#select-none").style=`
    position: relative;
    top: -0;
...
function love(){
  document.querySelector("#love1").style=`display:none`
  document.querySelector("#none1").style=`display:flex`
 }
 function loveExit(){
     document.querySelector("#love1").style=`display:flex`
